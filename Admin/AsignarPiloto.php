...
$CantidadPallets = ConteoPallets($NoGuia);
$CantidadPiking = ConteoPiking($NoGuia);



function ConteoPallets($Guia){


    include '../LQS_EUQ/Auth.php';
    $sentencia = $pdo->prepare("SELECT  sum( FLOOR(DetalleGuias.Cajas / (PR.BASE * PR.ALTURA))) as Pallets FROM 
    `DetalleGuias`
INNER JOIN 
    productos PR 
ON 
    DetalleGuias.Material = PR.IDH
WHERE 
    Transporte = $Guia; ");
    $sentencia->execute();
...
function ConteoPiking($Guia){


    include '../LQS_EUQ/Auth.php';
    $sentencia = $pdo->prepare("SELECT 
    SUM(Piking) as Picking
FROM 
    (SELECT 
        DetalleGuias.*, 
        PR.BASE * PR.ALTURA as Paletizado, 
        FLOOR(DetalleGuias.Cajas / (PR.BASE * PR.ALTURA)) as Pallets,
        IF(FLOOR(DetalleGuias.Cajas / (PR.BASE * PR.ALTURA)) > 1, 
            DetalleGuias.Cajas - (PR.BASE * PR.ALTURA * FLOOR(DetalleGuias.Cajas / (PR.BASE * PR.ALTURA))), 
            DetalleGuias.Cajas
        ) as Piking
    FROM 
        `DetalleGuias`
...
try {
     ...
     if (isset($_GET['Guia'])) {
         ...
         $txtResponsablePreparar= $Result['RespPrepara'];
         $txtResponsableDobleChequeo= $Result['RespChequeo'];
         $txtAyudanteResponsable= $Result['Ayudante'];
         $txtPlacaCabezal= $Result['Placa'];
...
switch ($accion) {
    ...
    case "btnRegistrar":
        try{
            ...
            $txtPikeador = (isset($_POST['txtPikeador'])) ? $_POST['txtPikeador'] : "";
            // Campos Nuevos
            $txtMarchamo =(isset($_POST['txtMarchamo'])) ? $_POST['txtMarchamo'] : "";
            $txtResponsablePreparar= (isset($_POST['txtResponsablePreparar'])) ? $_POST['txtResponsablePreparar'] : "";
            $txtResponsableDobleChequeo= (isset($_POST['txtResponsableDobleChequeo'])) ? $_POST['txtResponsableDobleChequeo'] : "";
            $txtAyudanteResponsable= (isset($_POST['txtAyudanteResponsable'])) ? $_POST['txtAyudanteResponsable'] : "";
            $txtPlacaCabezal= (isset($_POST['txtPlacaCabezal'])) ? $_POST['txtPlacaCabezal'] : "";
            $txtPlacaFurgon= (isset($_POST['txtPlacaFurgon'])) ? $_POST['txtPlacaFurgon'] : "";
            $txtVerificador= (isset($_POST['txtVerificador'])) ? $_POST['txtVerificador'] : "";


            //Actualizar datos del registro de la 16H
            $SQL = "UPDATE dbs9098416.Guias  SET Verificador = '".$txtVerificador."', PlacaFurgon= '".$txtPlacaFurgon."',Placa = '".$txtPlacaCabezal."',Ayudante = '".$txtAyudanteResponsable."',RespChequeo='".$txtResponsableDobleChequeo."', RespPrepara = '".$txtResponsablePreparar."', Marchamo = '".$txtMarchamo."', Piloto = '".$txtPiloto."',Transportista = '".$txtTransportista."' ,Rampa = '".$txtRampa."',Montacarguista = '".$txtMontaCarguista."' where Transporte = '".$NoGuia."' " ;
            $sentencia = $pdo->prepare($SQL);
            ...
            header('Location: Guias_AsignarTransportista.php');
        } catch (Exception $ex) {
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card">
                                ...
                                <br>
                                <!-- Se crea un resumen de conteo para saber cuantos pallets hay y cuantos piking hay en la guia-->
                                    ...
                                    <div class="col-md-6 col-lg-3 col-xlg-3 animate__animated animate__backInUp" style="animation-duration: 1.25s;">
                                        <div class="card card-hover">
                                            <div class="p-2 bg-primary text-center">
                                                <h1 id="CantidadPallets" class="font-light text-white"><?php echo $CantidadPallets; ?></h1>
                                                <h6 class="text-white">Cantidad de Pallets</h6>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Column -->
                                    <div class="col-md-6 col-lg-3 col-xlg-3 animate__animated animate__backInUp" style="animation-duration: 1.5s;">
                                        <div class="card card-hover">
                                            <div class="p-2 bg-success text-center">
                                                <h1 id="CantidadPiking" class="font-light text-white"><?php echo $CantidadPiking; ?></h1>
                                                <h6 class="text-white">Cantidad de Piking</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <form role="form" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="txtMarchamo" type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtMarchamo ?>"  >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Responsable de preparar</label>
                                                    <input name="txtResponsablePreparar" type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtResponsablePreparar ?>"  >
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Responsable doble chequeo</label>
                                                    <input name="txtResponsableDobleChequeo" type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtResponsableDobleChequeo ?>"  >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Ayudante Responsable</label>
                                                    <input name="txtAyudanteResponsable" type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtAyudanteResponsable ?>"  >
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="txtPlacaCabezal" type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtPlacaCabezal ?>"  >
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <label>Rampa</label>
                                                    <select required class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="txtRampa" id="txtRampa" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled">
                                                        <option style="display:none; height:50px;" value="" class="ng-binding">
                                                            --- Rampa ---
                                                        </option>

                                                        <option  value="Rampa 1" class="ng-binding">
                                                            Rampa 1
                                                        </option>

                                                        <option  value="Rampa 2" class="ng-binding">
                                                            Rampa 2
                                                        </option>

                                                        <option  value="Rampa 3" class="ng-binding">
                                                            Rampa 3
                                                        </option>

                                                        <option  value="Rampa 4" class="ng-binding">
                                                            Rampa 4
                                                        </option>

                                                        <option  value="Rampa 5" class="ng-binding">
                                                            Rampa 5
                                                        </option>

                                                        <option  value="Rampa 6" class="ng-binding">
                                                            Rampa 6
                                                        </option>

                                                        <option  value="Rampa 7" class="ng-binding">
                                                            Rampa 7
                                                        </option>

                                                        <option  value="Rampa 8" class="ng-binding">
                                                            Rampa 8
                                                        </option>
