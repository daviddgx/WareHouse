...
include '../LQS_EUQ/LST_GCDS_Pendientes.php';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Calcular Ubicaciones FiFo</h4>
                            <h6 class="card-subtitle">Calcular la asignacion de las ubicaciones para despachar</h6>
                            <br>
