...
switch ($accion) {
    ...
    case 'btnBloquearCarril':
        ...
        $sqlDatos = "update `posiciones` set EstatusProducto = 'Cuarentena', EstatusUbicacion = 'Cuarentena',Observaciones= 'Carril Bloqueado por Cuarentena el $fechaActualizacion por $txtUsuario ' where bodega = '$txtBodegaOrigen' and Carril = '$txtCarrilOrigen' and idh = '$txtIDHOrigen' ";
        ...
        $Mensajeerror = '<div class="alert alert-secondary alert-dismissible bg-success text-white border-0 fade show" role="alert">
            ...
            <strong>Se bloqueo el IDH "'.$txtIDHOrigen.'" en carril "'.$txtCarrilOrigen.'" de la bodega "'.$txtBodegaOrigen.'" -- </strong> Los pallets de este carril ya no seran tomadas en cuenta para el despacho
        </div>';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Bloquear Carril Por Cuarentena </h4>
                            <h6 class="card-subtitle">Bloquee un Carril que no pueda ser despachado por consepto de Cuarentena</h6>
                            <br>
                                            ...
                                            <div class="row" style="text-align: center">
                                                <div class="col-md-2" style="text-align: center">
                                                    <button type="submit" value="btnBloquearCarril" name="accion"
                                                            class="btn btn-outline-success">Bloquear carril con IDH seleccionado
                                                    </button>
                                                </div>
