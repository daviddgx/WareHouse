...
switch ($accion) {
   ...
   // Proceso nuevo
        ...
        $sqlDatos = "update `posiciones` set EstatusProducto = 'Calidad', EstatusUbicacion = 'Calidad',Observaciones= 'Carril Bloqueado por calidad el $fechaActualizacion por $txtUsuario ' where bodega = '$txtBodegaOrigen' and Carril = '$txtCarrilOrigen' and idh = '$txtIDHOrigen' ";
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Bloquear Carril Por Calidad </h4>
                            <h6 class="card-subtitle">Bloquee un Carril que no pueda ser despachado por consepto de calidad</h6>
                            <br>
