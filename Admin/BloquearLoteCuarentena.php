...
switch ($accion) {
    ...
    case 'btnBloqueoLote':
        ...
        $sentencia = $pdo->prepare("update `posiciones` set EstatusProducto = 'Cuarentena',EstatusUbicacion = 'Cuarentena',Observaciones = '$txtComentario' where IDH = $txtIDH and LoteProduccion = '$txtLote'");
        $sentencia->execute();
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Bloquear Lote Por Cuarentena </h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align: center">
                                                    <button type="submit" value="btnBloqueoLote" name="accion"
                                                            class="btn btn-outline-success">Bloquear Lote Por Cuarentena
                                                    </button>
                                                </div>
