...
switch ($accion) {
    ...
    case 'btnBloquearUbicacion':
        ...
        $sqlDatos = "update posiciones set EstatusUbicacion = 'Cuarentena', EstatusProducto ='Cuarentena',Observaciones = 'Bloqueo individual por: $txtUsuario al: $fechaActualizacion'  where Ubicacion = '$txtUbicacion'"; ;
        ...
        $Mensajeerror = '<div class="alert alert-secondary alert-dismissible bg-success text-white border-0 fade show" role="alert">
                ...
                <strong>Se bloqueo correctamente la Ubicacion ' . $txtUbicacion . ' Por favor valide en el mantenimiento de bodegas. -- </strong> Puede validar <a href="DetalleUbicaciones.php?Ubicacion='.$txtUbicacion.'">aquí</a>.
            </div>';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Bloquear Ubicacion Por Cuarentena </h4>
                            <h6 class="card-subtitle">Ingrese el nombre de la ubicacion, Ingrese el nombre tal commo esta en mantenimiento de bodegas</h6>
                            <br>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align: center">
                                                    <button type="submit" value="btnBloquearUbicacion" name="accion"
                                                            class="btn btn-outline-success">Bloquear Ubicacion Por Cuarentena
                                                    </button>
                                                </div>
