...
switch ($accion) {
    ...
    $txtBodegaOrigen = (isset($_POST['ListaBodegasOrigen'])) ? $_POST['ListaBodegasOrigen'] : "";
        ...
        $sqlDatos = "update posiciones set EstatusUbicacion = 'Calidad', EstatusProducto ='Calidad',Observaciones = 'Bloqueo individual por: $txtUsuario al: $fechaActualizacion'  where Ubicacion = '$txtUbicacion'"; ;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Bloquear Ubicacion Por Calidad </h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align: center">
                                                    <button type="submit" value="btnBloquearUbicacion" name="accion"
                                                            class="btn btn-outline-success">Bloquear Ubicacion Por Calidad
                                                    </button>
                                                </div>
