...
switch ($accion) {
    ...
    case "btnConsultar":
        $IDHConsulta = (isset($_POST['txtBuscarIDH'])) ? $_POST['txtBuscarIDH'] : "";
        
        include '../LQS_EUQ/RPTTrazabilidadLote.php';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body" >
                            <h4 class="card-title">Seleccione el IDH para mostrar las fechas de produccion disponibles</h4>
                            <h6 class="card-subtitle">Se mostraran las fechas de produccion no la fecha de ingreso al sistema. </h6>
                            <br>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Detalle de trazabilidad (Reporte por fechas)</h4>
                            <h6 class="card-subtitle"> Segun lote de produccion</h6>
                            <br>
                            ...
                            <table id="example" class="table table-striped  " cellspacing="0" width="100%" >
                                ...
                                for ($i = 0; $i < $lista_DespachoPRODUCCION; $i++) {
                                    ...
                                    echo "</td>";
                                    echo "<td>";
                                    echo date('d-m-Y', strtotime($lista_DespachoPRODUCCION['Produccion']));
                                    echo "</td>";
                                    echo "<td>";
                                    echo date('d-m-Y', strtotime($lista_DespachoPRODUCCION['Ingreso']));
                                    echo "</td>";
                                    echo "<td>";
                                    ...
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['registros'];
                                    echo "</td>";

                                    
                                    echo "<td>";
                                    echo '<a href="DetalleTrazabilidadLote.php?IDH=' . $lista_DespachoPRODUCCION['IDH'] . '&Lote=' . $lista_DespachoPRODUCCION['Produccion'] . '" class="fas fa-list-alt btn btn-success "> Detalle</a>';
                                    echo "</td>";
