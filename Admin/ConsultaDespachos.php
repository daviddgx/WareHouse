...
switch ($accion) {
    ...
    case "btnConsultar":
        ...
        include '../LQS_EUQ/RPTDespachosFIFO.php';
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Detalle de exportaciones (Reporte de Despachos)</h4>
                                <h6 class="card-subtitle"> Valide los registros del dia</h6>
                                <br>

                                <div class="text-center">

                                    <input style="margin-left: 2rem" class="btn btn-outline-info" type="button" value="Descargar Reporte" onclick="enviarFormulario('<?php echo $HoraTrabajoInicio; ?>','<?php echo $HoraTrabajoFinal; ?>')">

                                    <script>
                                        function enviarFormulario(Fecha1, Fecha2) {
                                            var url = "../innet_ADM/ExportarDespachosFIFO.php?fecha1=" + Fecha1 + "&fecha2=" + Fecha2;
                                            window.open(url, "Descargar Despachos", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=500,height=150");
                                        }
                                    </script>
                                ...
                                <div class="dataTables_wrapper" style="overflow-x: auto;">
                                    <table id="example" class="table table-striped  " cellspacing="0" width="100%" >
                                        ...
                                        <th> A_ESTADO </th>
                                        <th> A_IDH </th>
                                        <th> A_PALLETCOMPLETO </th>
                                        <th> A_UNIDADESENPALLET </th>
                                        <th> A_ORIGEN </th>
                                        <th> A_FECHAPRODUCCION </th>
                                        <th> A_LOTEPRODUCCION </th>
                                        <th> A_FECHAINGRESO </th>
                                        <th> A_FECHAVENCIMIENTO </th>
                                        <th> A_FECHACUARENTENA </th>
                                        <th> A_CANTIDAD </th>
                                        <th> A_ESTATUSPRODUCTO </th>
                                        <th> A_VERIFICADOR </th>
                                        <th> A_MONTACARGUISTA </th>
                                        <th> A_TURNO </th>
                                        <th> A_ESTATUSUBICACION </th>
                                        <th> A_OBSERVACIONES </th>
                                        <th> B_MOVIMIENTO </th>
                                        <th> B_GUIACARGA </th>
                                        <th> B_ENTREGA </th>
                                        <th> B_IDH </th>
                                        ...
                                        <th> B_POSICION </th>
                                        <th> B_RAMPA </th>
                                        <th> B_FECHADESPACHO </th>
                                        <th> B_FECHAREALIZADO </th>
                                        <th> B_OPERADOR </th>
                                        <th> B_ESTATUS </th>
                                        ...
                                        for ($i = 0; $i < $lista_DespachoPRODUCCION; $i++) {
                                            echo "<tr>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_BODEGA'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_CARRIL'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_POSICION'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_NIVEL'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_UBICACION'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_ESTADO'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_IDH'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_PALLETCOMPLETO'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_UNIDADESENPALLET'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_ORIGEN'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_FECHAPRODUCCION'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_LOTEPRODUCCION'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_FECHAINGRESO'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_FECHAVENCIMIENTO'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_FECHACUARENTENA'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_CANTIDAD'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_ESTATUSPRODUCTO'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_VERIFICADOR'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_MONTACARGUISTA'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_TURNO'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_ESTATUSUBICACION'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['A_OBSERVACIONES'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['B_MOVIMIENTO'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['B_GUIACARGA'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['B_ENTREGA'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['B_IDH'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['B_DESCRIPCION'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['B_POSICION'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['B_RAMPA'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['B_FECHADESPACHO'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['B_FECHAREALIZADO'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['B_OPERADOR'];
                                            echo "</td>";
                                            echo "<td>";
                                            echo $lista_DespachoPRODUCCION['B_ESTATUS'];
                                            echo "</td>";
