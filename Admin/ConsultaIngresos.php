            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Lista de Produccion (Reporte de ingresos)</h4>
                            ...
                            <div class="text-center">
                                ...
                                <script>
                                    function enviarFormulario(Fecha1, Fecha2) {
                                        var url = "../innet_ADM/ExportarIngresosFIFO.php?fecha1=" + Fecha1 + "&fecha2=" + Fecha2;
                            ...
                            <table id="example" class="table table-striped  " cellspacing="0" width="100%" >
                                ...
                                <th> Fecha Colocado </th>
                                <th> Estado </th>
                                <th> Operador </th>
                                <th> Pallet Completo </th>
                                <th> Cantidades </th>
                                <th> Peso Bruto por Caja </th>
                                <th> Toneladas Brutas Ingresadas </th>
                                <th> Origen </th>
                                ...
                                for ($i = 0; $i < $lista_DespachoPRODUCCION; $i++) {
                                    ...
                                    echo "<td>";
                                     ...
                                     echo "</td>";
                                     echo "<td>";
                                     echo date('d-m-Y H:i:s', strtotime($lista_DespachoPRODUCCION['FechaColocado']));
                                     echo "</td>";
                                     echo "<td>";
                                     ...
                                     echo "</td>";
                                     echo "<td>";
                                     echo $lista_DespachoPRODUCCION['PalletCompleto'];
                                     echo "</td>";
                                     echo "<td>";
                                     ...
                                     // Campos Nuevos
                                     echo "<td>";
                                     echo $lista_DespachoPRODUCCION['PesoBrutoCaja'];
                                     echo "</td>";

                                     echo "<td>";
                                     echo $lista_DespachoPRODUCCION['PesoBrutoIngreso_TONS'];
                                     echo "</td>";
                                     ...
                                     echo "</td>";
                                     echo "<td>";
                                     echo $lista_DespachoPRODUCCION['LoteProduccion'];
                                     echo "</td>";
                                     echo "<td>";
                                     echo date('d-m-Y H:i:s', strtotime($lista_DespachoPRODUCCION['FechaIngreso']));
                                     echo "</td>";
                                     echo "<td>";
                                     echo date('d-m-Y H:i:s', strtotime($lista_DespachoPRODUCCION['FechaVencimiento']));
                                     echo "</td>";
                                     echo "<td>";
                                     echo date('d-m-Y H:i:s', strtotime($lista_DespachoPRODUCCION['FechaCuarentena']));
                                     echo "</td>";
                                     echo "<td>";
                                     echo $lista_DespachoPRODUCCION['Verificador'];
                                     echo "</td>";
                                     echo "<td>";
                                     echo $lista_DespachoPRODUCCION['EstatusProducto'];
                                     echo "</td>";
                                     echo "<td>";
                                     echo $lista_DespachoPRODUCCION['Observaciones'];
                                     echo "</td>";
                                    echo "</tr>";
