...
switch ($accion) {
    ...
    case "btnConsultar":
        ...
        $HoraTrabajoInicio = $Fecha1 ;
        $HoraTrabajoFinal = $Fecha2 ;

        
        include '../LQS_EUQ/RPTTrazabilidadDespachos.php';

        $txtFechaInicial2 = $Fecha1 ;
        $txtFechaFinal2 = $Fecha2 ;
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body" >
                            ...
                            <h6 class="card-subtitle">Detalle de trazabilidad de despachos </h6>
                            <br>

                            <div class="my-content formulario text-center">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Detalle de trazabilidad (Reporte de Despachos)</h4>
                            <h6 class="card-subtitle"> Valide los registros segun las fechas seleccionadas</h6>
                            <br>
                            ...
                            <div class="text-center">
                                ...
                                <script>
                                    function enviarFormulario(Fecha1, Fecha2) {
                                        var url = "../innet_ADM/ExportarTrazabilidadDespachos.php?fecha1=" + Fecha1 + "&fecha2=" + Fecha2;
                                        window.open(url, "Descargar Ingresos", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=500,height=150");
                                    }
                                </script>
                            ...
                            <table id="example" class="table table-striped  " cellspacing="0" width="100%" >
                                ...
                                <th> Notas </th>
                                <th> MesesVidaUtil </th>
                                <th> Tapado/NoTapado </th>
                                <th> Libre </th>
                                <th> Bultos </th>
                                <th> Linea </th>
                                <th> PesoPorCajas </th>
                                <th> Cajas </th>
                                <th> PesoDeDespacho </th>
                                <th> FechaDespacho </th>
                                <th> nombre_dia </th>
                                <th> nombre_mes </th>
                                <th> TiempoDeDespacho </th>
                                ...
                                for ($i = 0; $i < $lista_DespachoPRODUCCION; $i++) {
                                    ...
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['Nivel'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['Descripcion'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['Bodega'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['IDH'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['FechaProduccion'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['FechaVencimiento'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['Operador'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['Turno'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['Tapado/Libre'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['NombreDestino'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['Transportista'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['Transporte'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['HoraDeDespacho'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['Notas'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['MesesVidaUtil'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['Tapando/NoTapando'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['ProductoEsta'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['CAJASXPALET'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['LINEA'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['PesoPorCaja'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['Cajas'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['PesoDeDespacho'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['FechaDespacho'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['nombre_dia'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['MES'];
                                    echo "</td>";
                                    echo "<td>";
                                    echo $lista_DespachoPRODUCCION['TiempoDeDespacho'];
                                    echo "</td>";
