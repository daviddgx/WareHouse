...
include '../LQS_EUQ/LST_PosicionesCalidad.php';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Consultar Ubicaciones que estan bloqueadas por calidad </h4>
                            <h6 class="card-subtitle">Se puede hacer la consulta por IDH / Lote</h6>
                            <br>
                                ...
                                <form role="form" action="" method="post" class="">
                                    <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                        ...
                                        for ($i = 0; $i < $lista_Productos; $i++) {
                                            ...
                                            echo "<td>";
                                            echo '<a href="DetalleUbicacionesCalidad.php?Ubicacion=' . $lista_Productos['Ubicacion'] . '" class="btn btn-success">Detalle</a>';
                                            echo "</td>";
