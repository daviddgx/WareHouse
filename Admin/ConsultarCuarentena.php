...
include '../LQS_EUQ/LST_PosicionesCuarentena.php';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Consultar Ubicaciones que estan bloqueadas por Cuarentena y su fecha de liberacion </h4>
                                ...
                                <form role="form" action="" method="post" class="">
                                    <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                        ...
                                        for ($i = 0; $i < $lista_Productos; $i++) {
                                            ...
                                            echo "<td>";
                                            echo $lista_Productos['Unidades'];
                                            echo "</td>";



                                            echo "<td>";
                                            echo '<a href="ConsultarCuarentenaDetalle.php?IDH=' . $lista_Productos['IDH'] . '&FechaCuarentena=' . $lista_Productos['FechaCuarentena'] . '" class="icon-social-dropbox  btn btn-Sertero"></a>';
