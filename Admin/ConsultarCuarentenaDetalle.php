...
$fechaCuarentena = $_GET['FechaCuarentena'];
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Consultar Ubicaciones que estan bloqueadas por Cuarentena </h4>
                            <h6 class="card-subtitle">El detalle es del IDH anteriormente seleccionado</h6>
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav ">
                                        ...
                                        <li class="nav-item active">
                                            <a class="btn btn-outline-danger" style="margin-left: 2rem" href="ConsultarCuarentena.php"><span > Regresar </span></a>
                                        </li>
                                ...
                                <form role="form" action="" method="post" class="">
                                    <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                        ...
                                        for ($i = 0; $i < $lista_Productos; $i++) {
                                            ...
                                            echo "<td>";
                                            echo '<a href="DetalleUbicacionesCuarentena.php?Ubicacion=' . $lista_Productos['Ubicacion'] . '&IDH=' . $lista_Productos['IDH'] . '&FechaCuarentena=' . date('Y-m-d', strtotime($lista_Productos['FechaCuarentena'])) . '" class="icon-social-dropbox  btn btn-Sertero"></a>';
