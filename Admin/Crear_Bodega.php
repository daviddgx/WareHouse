...
switch ($accion) {
    case "btnModificar":
        ...
        $txtNombreBodega =  (isset($_POST['txtNombreBodega'])) ? $_POST['txtNombreBodega'] : "";
        $txtDescripcion =   (isset($_POST['txtDescripcion'])) ? $_POST['txtDescripcion'] : "";
        $txtUbicacion =     (isset($_POST['txtUbicacion'])) ? $_POST['txtUbicacion'] : "";
        $txtDireccion =     (isset($_POST['txtDireccion'])) ? $_POST['txtDireccion'] : "";
        $txtEstado =        (isset($_POST['txtEstado'])) ? $_POST['txtEstado'] : "";
        $txtNiveles =0;
        $txtCapacidadActual =0;
        $txtPosiciones =0;
        $txtCarriles =0;
        $txtPosicionesCarriles =0;


            //Actualizar datos del registro

            $sentencia = $pdo->prepare("INSERT INTO `dbs9098416`.`warehauses` (`Nombre_Bodega`,`Descripcion`, `Carriles`,`PocisionesCarriles`,`Niveles`,`CapacidadActual`,`Posiciones`,`Ubicacion`,`Direccion`,`Estado`) VALUES(:Nombre_Bodega,:Descripcion,:Carriles,:PocisionesCarriles,:Niveles,:CapacidadActual,:Posiciones,:Ubicacion,:Direccion,:Estado)");

            $sentencia->bindParam(':Nombre_Bodega', $txtNombreBodega);
            $sentencia->bindParam(':Descripcion', $txtDescripcion);
            $sentencia->bindParam(':Carriles', $txtCarriles);
            $sentencia->bindParam(':PocisionesCarriles', $txtPosicionesCarriles);
            $sentencia->bindParam(':Niveles', $txtNiveles);
            $sentencia->bindParam(':CapacidadActual', $txtCapacidadActual);
            $sentencia->bindParam(':Posiciones', $txtPosiciones);
            $sentencia->bindParam(':Ubicacion', $txtUbicacion);
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Crear una Bodega</h4>
                            <h6 class="card-subtitle">Cree y registre los datos generales de una bodega</h6>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="txtNombreBodega" type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtNombreBodega ?>"  required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="txtEstado" id="txtEstado" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled">
                                                        ...
                                                        <option  value="Activa" class="ng-binding">
                                                            ACTIVA
                                                        </option>
                                                        <option  value="Inactiva" class="ng-binding">
                                                            INACTIVA
                                                        </option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="txtUbicacion" id="txtUbicacion" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled">
                                                        <option style="display:none; height:50px;" value="" class="ng-binding">
                                                            --- UBICACION ---
                                                        </option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtDireccion"
                                                           class="form-control"
                                                           value="<?php echo $txtDireccion ?>"  required>
                                                </div>
                                            </div>
                                ...
                                <form>
                                    <div class="form-actions">
                                        <div class="text-center">
                                                ...
                                                <a class="btn btn-outline-danger" style="margin-left: 2rem" href="Mantenimiento_Bodegas.php"><span > Regresar </span></a>
                                            <button type="submit" value="btnModificar" name="accion"
                                                    class="btn btn-outline-success">Crear Bodega
                                            </button>
