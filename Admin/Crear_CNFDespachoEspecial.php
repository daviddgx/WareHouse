...
switch ($accion) {
    case "btnModificar":
        ...
        $txtUnidades=  (isset($_POST['txtUnidades'])) ? $_POST['txtUnidades'] : "";
            ...
            $sentencia = $pdo->prepare("insert into dspachos_especiales values (:Cliente,:IDH,(select UNIDADESXMEDIDA from productos where IDH = :IDH),:Unidades)");

            $sentencia->bindParam(':IDH', $txtIDH);
            $sentencia->bindParam(':Cliente', $txtCliente);
            $sentencia->bindParam(':Unidades', $txtUnidades);

            $sentencia->execute();

                $MensajeExito = '<div class="alert alert-success" role="alert">
                                    <strong>Excelente!   -- </strong> Los datos se registraron correctamente, Ya puede regresar a la pantalla anterior
                                </div>';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Configuracion Para despachos Especiales</h4>
                            <h6 class="card-subtitle">Configure un IDH para un cliente y determine las uidades a despachar por para este cliente</h6>
                                ...
                                <form role="form" action="" method="post" enctype="multipart/form-data">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select required class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="txtCliente" id="txtCliente" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled" >
                                                        ...
                                                        $cargos = "SELECT NombreDestino FROM dbs9098416.Guias group by NombreDestino;";

                                                        $result = $conn->query($cargos);
                                                        if ($result->num_rows > 0) {
                                                            while ($row = $result->fetch_assoc()) {

                                                                echo '<option value="' . $row['NombreDestino'] . '">' . utf8_encode($row['NombreDestino'])  . '</option>';
                                                            }
                                                        }
                                                        ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Material / IDH</label>
                                                    <select required class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="txtIDH" id="txtIDH" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled" >
                                                        <option style="display:none; height:50px;" value="" class="ng-binding">
                                                            --- IDH ---
                                                        </option>
                                                        ...
                                                        <?php
                                                        $conn = new mysqli($servername, $username, $password, $dbname);
                                                        $cargos = "select IDH,Descripcion from productos ";
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Unidades a despachar por cada unidad en la guia de SAP</label>
                                                    <input type="number" name="txtUnidades"
                                                           class="form-control"
                                                           value=""  required >
                                ...
                                <form>
                                    <div class="form-actions">
                                        <div class="text-center">
                                                ...
                                                <a class="btn btn-outline-danger" style="margin-left: 2rem" href="DespachosEspeciales.php"><span > Regresar </span></a>
                                            <button type="submit" value="btnModificar" name="accion"
                                                    class="btn btn-outline-success">Crear Registro
                                            </button>
