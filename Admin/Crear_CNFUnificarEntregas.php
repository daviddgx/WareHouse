...
switch ($accion) {
    case "btnModificar":
        ...
        $txtCliente=  (isset($_POST['txtCliente'])) ? $_POST['txtCliente'] : "";
            ...
            $sentencia = $pdo->prepare("insert into unificacion_entregas values (:Cliente,'Si')");
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Configuracion para unificar entregas</h4>
                            <h6 class="card-subtitle">los clientes ya configurados no saldran en la lista</h6>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select required class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="txtCliente" id="txtCliente" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled" >
                                                        ...
                                                        $cargos = "SELECT NombreDestino FROM dbs9098416.Guias where NombreDestino not in (select Cliente from unificacion_entregas) group by NombreDestino;";
                                ...
                                <form>
                                    <div class="form-actions">
                                        <div class="text-center">
                                                ...
                                                <a class="btn btn-outline-danger" style="margin-left: 2rem" href="Unificaciondeentregas.php"><span > Regresar </span></a>
