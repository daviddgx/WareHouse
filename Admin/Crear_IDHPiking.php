            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Configuracion de nuevo IDH para Piking</h4>
                            <h6 class="card-subtitle">Puede configurar un IDH que no este configurado, y debe ser una ubicacion que no este configurada</h6>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select required class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="txtIDH" id="txtIDH" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled" >
                                                        ...
                                                        $cargos = "SELECT IDH,Descripcion FROM dbs9098416.productos where IDH not in (select IDH from config_piking where IDH is not Null); ";
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select required class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="txtUbicacion" id="txtUbicacion" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled" >
                                                        ...
                                                        <?php
                                                        $conn = new mysqli($servername, $username, $password, $dbname);
                                                        $cargos = "SELECT * FROM dbs9098416.config_piking where IDH is null; ";
                                ...
                                <form>
                                    <div class="form-actions">
                                        <div class="text-center">
                                                ...
                                                <a class="btn btn-outline-danger" style="margin-left: 2rem" href="Mantenimiento_Piking.php"><span > Regresar </span></a>
