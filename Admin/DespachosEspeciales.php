...
include '../LQS_EUQ/LST_DespachosEspeciales.php';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Configuracion de Despachos Especiales</h4>
                            <h6 class="card-subtitle">Configuracion de despachos para lientes especificos </h6>
                            <br>
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav ">
                                        <li class="nav-item active">
                                            <a class="btn btn-outline-success" style="margin-left: 2rem" href="Crear_CNFDespachoEspecial.php"><span > Configurar Nuevo IDH para despacho especial </span></a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
                            ...
                            <form role="form" action="" method="post" class="">
                                <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                    ...
                                    <th>IDH</th>
                                    <th>Descripcion</th>
                                    <th>Unidades de despacho Actual</th>
                                    <th>Unidades de despacho para este Cliente</th>
                                    ...
                                    for ($i = 0; $i < $lista_Productos; $i++) {
                                        ...
                                        echo "<td>";
                                        echo $lista_Productos['Nuevo'];
                                        echo "</td>";


                                        echo "<td>";
                                        echo '<a href="BorrarDespEsp.php?IDH=' . $lista_Productos['IDH'] . '&Cliente=' . $lista_Productos['Cliente'] . '" class="far fa-eye-slash btn btn-Sertero "></a>';
                                        echo "</td>";
