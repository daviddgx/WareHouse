...
try {
     ...
     if (isset($_GET['Guia'])) {
         $sql = "select FechaPedido,FechaEngrega,NombreDestino,Direccion,Lugar,Transportista from  dbs9098416.Guias where Transporte ='" . $NoGuia . "';";
                                ...
                                <nav class="navbar navbar-expand-lg text-center">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        ...
                                        <ul class="navbar-nav ">
                                            ...
                                            <li class="nav-item active">
                                                <a class="btn btn-outline-warning" style="margin-left: 2rem" href="AnularGuia.php?Guia=<?php echo $NoGuia?>"><span > Anular </span></a>
                                            </li>
