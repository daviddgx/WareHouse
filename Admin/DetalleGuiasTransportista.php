...
try {
     ...
     if (isset($_GET['Guia'])) {
         $sql = "select FechaPedido,FechaEngrega,NombreDestino,Direccion,Lugar,Transportista,Piloto from  dbs9098416.Guias where Transporte ='" . $NoGuia . "' ;";
...
FROM
    ...
    JOIN productos
     ON DetalleGuias.Material = productos.IDH where Transporte ='" . $NoGuia . "'  order by Material;";
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        <ul class="navbar-nav ">
                                            ...
                                            <li class="nav-item active">
                                                <a class="btn btn-outline-danger" style="margin-left: 2rem" href="Guias_AsignarTransportista.php"><span > Regresar </span></a>
                                            </li>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                            ...
                                            for ($i = 0; $i < $lista_Guias; $i++) {
                                                ...
                                                echo "<td>";
                                                echo '<a href="QuitarIDHDetalleGuias.php?Guia='.$lista_Guias['Transporte'].'&Entrega=' . $lista_Guias['Entrega'] .'&IDH='.$lista_Guias['Material'].'" class=" btn btn btn-outline-danger ">Cambiar piloto</a>';
                                                echo "</td>";
