...
$IDH_PAR = $_GET['Guia'];
include '../LQS_EUQ/LST_DTLLPKNG.php';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Estatus de Piking</h4>
                            <h6 class="card-subtitle">Validar cuantas unidades existen de un IDH especifico</h6>
                            <br>
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light bg-light ">
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav ">
                                        ...
                                        <li class="nav-item active">
                                            <a class="btn btn-outline-info" style="margin-left: 2rem" href="Mantenimiento_Piking_AgregarInventario.php?IDH=<?php echo $IDH_PAR?>"><span > Agregar al inventario </span></a>
                                        </li>
                            ...
                            <form role="form" action="" method="post" class="">
                                <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                    ...
                                    for ($i = 0; $i < $lista_Productos; $i++) {
                                        ...
                                        echo "<td>";
                                        echo $lista_Productos['LoteProduccion'];
                                        echo "</td>";
