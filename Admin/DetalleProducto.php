                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle">Valide la informacion de un producto</h6>
                                ...
                                <form role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtMarca ?>" readonly="" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtLINEA ?>" readonly="" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtUnidadDeMedida ?>" readonly="" required>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtUnidadPorMedida ?>" readonly="" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtBase ?>" readonly="" required>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- FIN Row para Elemento de formulario -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtAltura ?>" readonly="" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtPesoNetoUnitario . ' kg'?>" readonly="" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtPesoBrutoUnitario . ' kg'?>" readonly="" required>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- FIN Row para Elemento de formulario -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtPesoNetoCaja . ' kg'?> " readonly="" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtPesoBrutoCaja . ' kg'?> " readonly="" required>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- FIN Row para Elemento de formulario -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtDiasCuarentena . ' Dias'?>" readonly="" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtUnidadesMinimas ?>" readonly="" required>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtUnidadesMaximas ?>" readonly="" required>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- FIN Row para Elemento de formulario -->
                                    ...
                                    <div class="form-actions">
                                        <div class="text-center">
                                                ...
                                                <a class="btn btn-outline-success" style="margin-left: 2rem" href="Mantenimiento_Productos.php"><span > Regresar </span></a>
