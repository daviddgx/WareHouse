                                ...
                                <form role="form" action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-actions">
                                        <div class="text-center">
                                            ...
                                            <a class="btn btn-outline-success" style="margin-left: 2rem" href="ConsultarCuarentenaDetalle.php?IDH=<?php echo $IDHConsulta?>&FechaCuarentena=<?php echo $FechaCuarentena?>"><span > Regresar </span></a>
