...
switch ($accion) {
    case "btnModificar":
        ...
        $txtEstado =        (isset($_POST['txtEstado'])) ? $_POST['txtEstado'] : "";
            ...
            $sentencia = $pdo->prepare("UPDATE dbs9098416.warehauses SET  Descripcion=:Descripcion,Ubicacion=:Ubicacion, Direccion=:Direccion, Estado=:Estado where Nombre_Bodega=:Nombre_Bodega;");
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Editar Bodega</h4>
                            <h6 class="card-subtitle">Cambie la informacion gemeral de una bodega</h6>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="txtUbicacion" id="txtUbicacion" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled">
                                                        ...
                                                        <option  value="Interna" class="ng-binding">
                                                            INTERNA
                                                        </option>
                                                        <option  value="Externa" class="ng-binding">
                                                            EXTERNA
                                                        </option>
                                    ...
                                    <div class="form-actions">
                                        <div class="text-center">
                                            ...
                                            <button type="submit" value="btnModificar" name="accion"
                                                    class="btn btn-outline-success">Actualizar Bodega
                                            </button>
