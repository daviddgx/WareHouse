...
include '../LQS_EUQ/LST_EstadoUbicaciones.php';
include '../LQS_EUQ/LST_EstadoUbicacionesDetalle.php';
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Detalle de estatus de bodegas </h4>
                            <h6 class="card-subtitle">Por estatus</h6>
                            <br>
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-body ">
                        <h4 class="card-title">Detalle de estatus de bodegas </h4>
                        <h6 class="card-subtitle">Por estatus y por bodega</h6>
                            <br>
                            <table id="example2" class="table table-striped  " cellspacing="0" width="100%">
                                ...
                                <tbody>
                                <?php
                                for ($i = 0; $i < $lista_Detalle; $i++) {
                                    echo "<tr>";

                                    echo "<td>";
                                    echo $lista_Detalle['Estado'];
                                    echo "</td>";



                                    echo "<td>";
                                    echo $lista_Detalle['Bodega'];
                                    echo "</td>";

                                    echo "<td>";
                                    echo $lista_Detalle['Cantidad'];
                                    echo "</td>";
...
<script>
    $(document).ready(function() {
        $('#example2').DataTable({
            ...
            "pageLength": 50 // Define el número de líneas por página
        });
    });
</script>
