...
include '../LQS_EUQ/LST_Transportista.php';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Asignar Pickeador</h4>
                            <h6 class="card-subtitle">Asigne la lista de picking para despachar</h6>
                            <br>
                            ...
                            <div >
                                ...
                                <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                    ...
                                    for ($i = 0; $i < $lista_Guias; $i++) {
                                        ...
                                        echo "<td>";
                                        echo '<a href="AsignarPikeador.php?Guia=' . $lista_Guias['Transporte'] . '&Entrega=' . $lista_Guias['Entrega'] . '" class="  btn btn-outline-success">Pickeador</a>';
                                        echo "</td>";
