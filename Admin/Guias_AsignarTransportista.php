            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Complementar datos de la Guia</h4>
                            <h6 class="card-subtitle">Detalles que no se establecen en la carga de guias masiva</h6>
                            <br>
                            ...
                            <div >
                                ...
                                <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                    ...
                                    for ($i = 0; $i < $lista_Guias; $i++) {
                                        ...
                                        echo "<td>";
                                        echo '<a href="AsignarPiloto.php?Guia=' . $lista_Guias['Transporte'] . '" class="  btn btn-outline-success">Completar Guia</a>';
                                        echo "</td>";
