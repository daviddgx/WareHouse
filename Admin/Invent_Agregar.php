...
switch ($accion) {
    ...
    $txtCarril = (isset($_POST['txtCarrilDestino'])) ? $_POST['txtCarrilDestino'] : "";

   // echo $txtBodega. "   " . $txtCarril;
   include '../LQS_EUQ/UbicacionesLimpias.php';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Agregar un pallet a una ubicacion por correccion de inventario</h4>
                            <h6 class="card-subtitle">Seleccione la bodega y carril para mostrar las ubicaciones que se pueden corregir, solo se pude agregar productos a ubicaciones vacias </h6>
                            <br>
                            ...
                            <h4 class="card-title">  Seleccione la bodega y carril para mostrar las ubicaciones que se pueden corregir </h4>
                                ...
                                for ($i = 0; $i < $lista_Guias; $i++) {
                                    ...
                                    echo "<td>";
                                    echo $lista_Guias['Posicion'];
                                    echo "</td>";

                                    echo "<td>";
                                    echo $lista_Guias['Nivel'];
                                    echo "</td>";
                                    ...
                                    echo "<td>";
                                    echo '<a href="Invent_AgregarDetalle.php?Posicion=' . $lista_Guias['Ubicacion'] . '" class="btn btn-outline-info ">Corregir Ubicacion '. $lista_Guias['Ubicacion'] .'</a>';
                                    echo "</td>";
