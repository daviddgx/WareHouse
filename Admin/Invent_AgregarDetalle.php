...
switch ($accion) {
    ...
    $IDH = (isset($_POST['txt_IDH'])) ? $_POST['txt_IDH'] : "";
    $PaletCompleto = (isset($_POST['txt_PalletCompleto'])) ? $_POST['txt_PalletCompleto'] : "";
    $UnidadesEnPallet = (isset($_POST['txtUnidadesEnPallet'])) ? $_POST['txtUnidadesEnPallet'] : "";
    $FechaProduccion = (isset($_POST['txtFechaDeProduccion'])) ? $_POST['txtFechaDeProduccion'] : "";
    $FechaProduccion_formateada = date("Y-m-d", strtotime($FechaProduccion));
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Lllene la informacion para la ubicacion <?php echo $Ubicacion?></h4>
                            <h6 class="card-subtitle">llene cada campo con los datos indicados. </h6>
                            <br>
                            <?php echo $Mensajeerror; ?>
                            <?php echo $MensajeExito; ?>
                            <br>

                            <h4 class="card-title">  Llene los datos que a continuacion se le solicitan </h4>
                                <div class="my-content formulario">
                                    <form role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>IDH</label>
                                                    <select required class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="txt_IDH" id="txt_IDH" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled">
                                                        <option style="display:none; height:50px;" value="" class="ng-binding">--- IDH ---</option>
                                                        <?php
                                                        $conn = new mysqli($servername, $username, $password, $dbname);
                                                        $cargos = "SELECT IDH, Descripcion FROM `productos` order by IDH asc;";
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Pallet Completo</label>
                                                    <select required class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="txt_PalletCompleto" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled">
                                                        <option style="display:none; height:50px;" value="" class="ng-binding">--- Seleccione ---</option>
                                                        <option value="Si" class="ng-binding">Si</option>
                                                        <option value="No" class="ng-binding">No</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="txtUnidadesEnPallet" type="number"
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="txtFechaDeProduccion" ID="txtFechaDeProduccion" type="date"
                                                           class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"
                                                            required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input name="txtLoteDeProduccion" ID="txtLoteDeProduccion" type="text"
                                                           class="form-control" 
                                                            required>
                                                </div>
                                            </div>
                                            ...
                                            <script>
                                                document.getElementById('txtFechaDeProduccion').addEventListener('change', function() {
                                                    var fechaProduccion = document.getElementById('txtFechaDeProduccion').value;
                                                    document.getElementById('txtLoteDeProduccion').value = 'G.M. ' + fechaProduccion;
                                                });
                                            </script>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a class="btn btn btn-outline-danger" style="margin-left: 2rem" href="Invent_Agregar.php"><span > Regresar </span></a>
                                            <button type="submit" value="btnRegistrar" name="accion"
                                                    class="btn btn-outline-success">Generar Registro
                                            </button>
