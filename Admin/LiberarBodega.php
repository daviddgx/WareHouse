...
switch ($accion) {
    ...
    case 'btnIngresarMovimiento':
        ...
        $txtCarril = (isset($_POST['txtCarril'])) ? $_POST['txtCarril'] : "";
        ...
        //1. Validacion que exista la bodega
        $conn = new mysqli($servername, $username, $password, $dbname);
        $cargos = "SELECT Bodega FROM dbs9098416.posiciones where Bodega = '$txtBodega' group by Bodega;";

        $result = $conn->query($cargos);
        if ($result->num_rows > 0) {


            // Validar que exista el Carril
            $conn = new mysqli($servername, $username, $password, $dbname);
            $cargos = "SELECT Bodega,Carril FROM dbs9098416.posiciones where Bodega = '$txtBodega' and Carril = '$txtCarril' group by Bodega,Carril;";
            ...
            if ($result->num_rows > 0) {
                ...
                $txtQRY = "call dbs9098416.reset_posicion_Carril('$txtBodega', '$txtCarril');";
               ...
               // echo $txtQRY;
                ...
                $Mensajeerror = '<div class="alert alert-secondary alert-dismissible bg-success text-white border-0 fade show" role="alert">
                                    ...
                                    <strong>El carril '.$txtCarril.' de la bodega '.$txtBodega.' fue liberado correctamente -- </strong> Puede validar en el Maestro de bodegas las ubicaciones del carril.
                                </div>';
                ...
                $Mensajeerror = '<div class="alert alert-secondary alert-dismissible bg-danger text-white border-0 fade show" role="alert">
                                    ...
                                    <strong>El Carril '.$txtCarril.' no se encontro dentro de la bodega '.$txtBodega.'-- </strong> Por favor valide el nombre del carril que quiere libera para la bodega '.$txtBodega.'.
                                </div>';
            ...
            $Mensajeerror = '<div class="alert alert-secondary alert-dismissible bg-danger text-white border-0 fade show" role="alert">
                                    ...
                                    <strong>La bodega ('.$txtBodega.') No se encontro en el sistema-- </strong> Revise el nombre y valide de nuevo.
                                </div>';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Liberar todas la ubicaciones de una bodega </h4>
                            <h6 class="card-subtitle">Las Ubicaciones se liberar de forma inmediata, no se podra recuperar</h6>
                            <br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="miInput" name="txtBodega" value="<?php echo $txtBodega?>" placeholder="En Mayusculas ej: B1">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ¿Está seguro de que desea liberar Toda la bodega?
                                                        </div>
