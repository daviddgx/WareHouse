...
switch ($accion) {
    ...
    case 'btnBloquearCarril':
        ...
        $sqlDatos = "update `posiciones` set EstatusProducto = 'Ocupada', EstatusUbicacion = 'Libre',Observaciones = 'Carril Desbloqueado de calidad el $fechaActualizacion por $txtUsuario ' where bodega = '$txtBodegaOrigen' and Carril = '$txtCarrilOrigen' and idh = '$txtIDHOrigen' ";
        ...
        $Mensajeerror = '<div class="alert alert-secondary alert-dismissible bg-success text-white border-0 fade show" role="alert">
            ...
            <strong>Se libero de calidad el IDH "'.$txtIDHOrigen.'" en carril "'.$txtCarrilOrigen.'" de la bodega "'.$txtBodegaOrigen.'" -- </strong> Los pallets liberados, seran tomados en cuenta para despachar.
        </div>';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">desbloquear Carril Por Calidad </h4>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select   required class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="ListaBodegasOrigen" id="ListaBodegasOrigen" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled" >
                                                            ...
                                                            $cargos = "SELECT Bodega FROM posiciones where EstatusUbicacion = 'Calidad' group by Bodega;";
