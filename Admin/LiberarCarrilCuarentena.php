...
$fechaConsulta = date("d") . '-' . date("m") . '-' . date("Y");
...
switch ($accion) {
    ...
    case 'btnBloquearCarril':
        ...
        $txtIDHOrigen = (isset($_POST['txtIDHINPOrigen'])) ? $_POST['txtIDHINPOrigen'] : "";

        // Proceso nuevo

        $conn  = new PDO('mysql:host='.$servername.';dbname='.$dbname, $username, $password);
        $sqlDatos = "update `posiciones` set EstatusProducto = 'Ocupada', EstatusUbicacion = 'Libre',Observaciones = 'Carril Desbloqueado de Cuarentena el $fechaActualizacion por $txtUsuario ' where bodega = '$txtBodegaOrigen' and Carril = '$txtCarrilOrigen' and idh = '$txtIDHOrigen' ";
        ...
        $Mensajeerror = '<div class="alert alert-secondary alert-dismissible bg-success text-white border-0 fade show" role="alert">
            ...
            <strong>Se libero de Cuarentena el IDH "'.$txtIDHOrigen.'" en carril "'.$txtCarrilOrigen.'" de la bodega "'.$txtBodegaOrigen.'" -- </strong> Los pallets liberados, seran tomados en cuenta para despachar.
        </div>';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">desbloquear Carril Por Cuarentena </h4>
                            <h6 class="card-subtitle">desbloquee un IDH de un Carril que  pueda ser despachado </h6>
                            <br>
                                    ...
                                    <form role="form" action="" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select   required class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="ListaBodegasOrigen" id="ListaBodegasOrigen" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled" >
                                                            ...
                                                            $cargos = "SELECT Bodega FROM posiciones where EstatusUbicacion = 'Cuarentena' group by Bodega;";
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Carril a desbloquear</label>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="hidden" name="txtIDHINPOrigen" value="" id="txtIDHINPOrigen">
                                                        <div id="IDHOrigen">
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row" style="text-align: center">
                                                <div class="col-md-2" style="text-align: center">
                                                    <button type="submit" value="btnBloquearCarril" name="accion"
                                                            class="btn btn-outline-success">desbloquear carril con IDH seleccionado
                                                    </button>
                                                </div>
...
<script type="text/javascript">
    function recargarLista() {
        ...
        $.ajax({
            type: "POST",
            url: "CarrilesOriginalesDESCUA.php",
...
<script>
    function cambiarValorIDHOrigen() {
        var select = document.getElementById("ListaIDHOrigen");
        var input = document.getElementById("txtIDHINPOrigen");
        input.value = select.value;
    }
</script>
