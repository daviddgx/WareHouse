            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Liberacion de Lote bloqueado por Cuarentena </h4>
                            <h6 class="card-subtitle">Se liberara el lote indicado para poder despacharlo</h6>
                            <br>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2" style="text-align: center">
                                                    <button type="submit" value="btnBuscarEspecial" name="accion"
                                                            class="btn btn-outline-success">Validar Ubicaciones para Liberar
                                                    </button>
                                                </div>
