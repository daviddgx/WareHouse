            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Liberar Lote de Calidad </h4>
                            <h6 class="card-subtitle">Libere un Lote de un IDH que este en Calidad</h6>
                            <br>
                                ...
                                <div class="my-content formulario">
                                    <form role="form" action="" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            $cargos = "select  posiciones.IDH,productos.Descripcion, count(*) as Pallets from posiciones Inner Join productos  on posiciones.IDH = productos.IDH where  posiciones.EstatusProducto = 'Calidad' or posiciones.EstatusUbicacion = 'Calidad'  group by IDH order by IDH Asc;";
...
<script type="text/javascript">
    function recargarLista() {
        ...
        $.ajax({
            type: "POST",
            url: "LotesPorIDHDesbloquear.php",
