...
switch ($accion) {
    ...
    $sentencia = $pdo->prepare("update `posiciones` set EstatusProducto = 'Libre',EstatusUbicacion = 'Libre',Observaciones = '$txtComentario / DESCAL POR $txtUsuario el $fechaActualizacion' where IDH = $txtIDH and LoteProduccion = '$txtLote'");
    $sentencia->execute();
    ...
    //ANCHOR - Pendiente implementar Bitacora del proceso
            ...
            <strong>Se Ha desbloqueado el Lote "'.$txtLote.'" del IDH "'.$txtIDH.'" correctamente -- </strong> Estos pallets ya  pueden ser uados para el calculo de despacho.
        </div>';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Liberar Lote de Cuarentena </h4>
                            <h6 class="card-subtitle">Libere un Lote de un IDH que este en Cuarentena</h6>
                            <br>
                                ...
                                <div class="my-content formulario">
                                    <form role="form" action="" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            $cargos = "select  posiciones.IDH,productos.Descripcion, count(*) as Pallets from posiciones Inner Join productos  on posiciones.IDH = productos.IDH where  posiciones.EstatusProducto = 'Cuarentena' or posiciones.EstatusUbicacion = 'Cuarentena'  group by IDH order by IDH Asc;";
                                            ...
                                            ?>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                            <label>Lote a des bloquear</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align: center">
                                                    <button type="submit" value="btnBloqueoLote" name="accion"
                                                            class="btn btn-outline-success">Desloquear Lote Por Calidad
                                                    </button>
                                                </div>
...
<script type="text/javascript">
    function recargarLista() {
        ...
        $.ajax({
            type: "POST",
            url: "LotesPorIDHDesbloquearCuarentena.php",
