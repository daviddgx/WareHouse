            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Liberar Ubicacion Por Calidad </h4>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <select  class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="ListaBodegasOrigen" id="ListaBodegasOrigen" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled">
                                                            ...
                                                            $cargos = "SELECT PS.Bodega as Nombre_Bodega, WS.Descripcion FROM `posiciones` PS inner join warehauses WS on PS.Bodega = WS.Nombre_Bodega where EstatusUbicacion = 'Calidad' group by Bodega;";
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align: center">
                                                    <button type="submit" value="btnBloquearUbicacion" name="accion"
                                                            class="btn btn-outline-success">Desbloquear Ubicacion de Calidad
                                                    </button>
                                                </div>
