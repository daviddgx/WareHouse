                            ...
                            <nav class="navbar navbar-expand-lg navbar-light bg-light ">
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav ">
                                        ...
                                        <li>
                                                <form>
                                                    <input style="margin-left: 2rem" class="btn btn-outline-info" type="button" value="Descargar Archivo FiFo" onclick="enviarFormulario()">
                                                </form>
                                            </li>
                            ...
                            <form role="form" action="" method="post" class="">
                                <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                    ...
                                    for ($i = 0; $i < $lista_Productos; $i++) {
                                        ...
                                        if($lista_Productos['posiciones'] == 0){
                                            echo "N/A";
                                        }else{
                                        ...
                                        if($lista_Productos['posicionesocupadas'] == 0){
                                            echo "N/A";
                                        }else{
                                            echo $lista_Productos['posicionesocupadas'];
                                        }
                                        ...
                                        if($lista_Productos['cuarentena'] == 0){
                                            echo "N/A";
                                        }else{
                                            echo $lista_Productos['cuarentena'];
                                        }
                                        ...
                                        if($lista_Productos['calidad'] == 0){
                                            echo "N/A";
                                        }else{
                                            echo $lista_Productos['calidad'];
                                        }
                                        ...
                                        $Porcentaje = 0;
                                            ...
                                            else{$Porcentaje = bcdiv((($lista_Productos['posicionesocupadas'] / $lista_Productos['posiciones']) * 100),'1', 2 );}
                                        ...
                                        if($lista_Productos['Nombre_Bodega'] == 10){
                                          echo "";
                                        }else{
...
function enviarFormulario() {
    ...
    window.open("../innet_ADM/ExportarFIFO.php", "Descargar FIFO", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=500,height=150");
