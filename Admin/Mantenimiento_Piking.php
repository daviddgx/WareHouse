...
include '../LQS_EUQ/LST_PIKINGLIST.php';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Configuracion de Piking</h4>
                            <h6 class="card-subtitle">Se Establece la configuracion de Piking para despachos y almacenamiento </h6>
                            <br>
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav ">
                                        <li class="nav-item active">
                                            <a class="btn btn-outline-success" style="margin-left: 2rem" href="Crear_IDHPiking.php"><span > Configurar Nuevo IDH en Piking </span></a>
                                        </li>
                            ...
                            <form role="form" action="" method="post" class="">
                                <table id="example" class="table table-striped  " cellspacing="0" width="100%" style="text-align: center;">
                                    ...
                                    for ($i = 0; $i < $lista_Productos; $i++) {
                                        ...
                                        echo "<td>";
                                        echo $lista_Productos['MINIMOPICKING'];
                                        echo "</td>";
                                        ...
                                        if (empty($lista_Productos['Ubicacion'])) {
                                        ...
                                        echo "</td>";
                                            ...
                                            echo "<td>";
                                        echo '<a href="DetallePiking.php?Guia=' . $lista_Productos['IDH'] . '" class="fas fa-list-alt btn btn-success "></a>';
                                        echo "</td>";

                                        echo "<td>";
echo '<a href="EliminarPikingUbicacion.php?Guia=' . $lista_Productos['IDH'] . '" class="fa fa-trash btn btn-danger" onclick="return confirmarEliminacion()"></a>';
echo "</td>";
                                        }
...
<script>
    ...
    return confirm('¿Estás seguro de que quiere desasignar  la ubicación de este IDH?');
}
</script>
