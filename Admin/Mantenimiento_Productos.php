...
if (isset($_GET['IDH'])) {
    $IDH = $_GET['IDH'];
    // Aquí puedes realizar el código especial que desees con la variable $miVariable
    $Mensajeerror = '<div class="alert alert-success alert-dismissible bg-success text-white border-0 fade show" role="alert">
                                    ...
                                    <strong> ✔️ Se Actualizo correctamente la informacion del IDH ️ -- </strong> ' . $IDH . ' 
                                </div>';
} else {
    // La variable no fue pasada como parámetro en la URL
...
<body>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Mantenimiento de Productos</h4>
                                <h6 class="card-subtitle">Revise la configuración de los productos registrados </h6>
                                <br>
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        <ul class="navbar-nav ">
                                            <li class="nav-item active">
                                                <a class="btn btn-outline-success" style="margin-left: 2rem" href="Crear_Productos.php"><span> Crear Producto </span></a>
                                            </li>

                                            <li>
                                                <form>
                                                    <input style="margin-left: 2rem" class="btn btn-outline-info" type="button" value="Descargar Maestro" onclick="enviarFormulario()">
                                                </form>
                                            </li>
                                    ...
                                    <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            for ($i = 0; $i < $lista_Productos; $i++) {
                                                ...
                                                echo "<td>";
                                                echo $lista_Productos['LINEA'];
                                                echo "</td>";

                                                echo "<td>";
                                                echo $lista_Productos['CAJASXPALET'];
                                                echo "</td>";
                                                echo "<td>";
                                                ...
                                                echo "<td>";
                                                echo $lista_Productos['MARCA'];
                                                echo "</td>";

                                                echo "<td>";
                                                echo '<a href="DetalleProducto.php?Guia=' . $lista_Productos['IDH'] . '"class="fas fa-list-alt btn btn-Sertero"></a>';
                                                echo "</td>";

                                                echo "<td>";
                                                echo '<a href="EditarProducto.php?Guia=' . $lista_Productos['IDH'] . '" class="fas fa-edit btn btn-Sertero "></a>';
                                                echo "</td>";
    ...
    <script>
        ...
        function enviarFormulario() {
            ...
            window.open("../innet_ADM/ExportarMaestro.php", "Descargar Maestro", "toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=no,resizable=no,width=500,height=150");
