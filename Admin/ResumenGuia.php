...
try {
    ...
    if (isset($_GET['Guia'])) {
        $conn  = new PDO('mysql:host='.$servername.';dbname='.$dbname, $username, $password);
            ...
            $sqlDatos = "SELECT DetalleGuias_Carga.Transporte, DetalleGuias_Carga.Material, productos.Descripcion,(SUM(DetalleGuias_Carga.Pallets) * productos.CAJASXPALET) + SUM(DetalleGuias_Carga.piking)  as UnidadesTotales, ((SUM(DetalleGuias_Carga.Pallets) * productos.CAJASXPALET) + SUM(DetalleGuias_Carga.piking)) * productos.pesobrutocaja as Pesobruto,((SUM(DetalleGuias_Carga.Pallets) * productos.CAJASXPALET) + SUM(DetalleGuias_Carga.piking)) * productos.pesonetocaja  as PesoNeto, SUM(DetalleGuias_Carga.Pallets) as total_pallets, SUM(DetalleGuias_Carga.piking) as total_piking 
FROM `DetalleGuias_Carga` 
join 
productos on DetalleGuias_Carga.Material = productos.IDH
WHERE Transporte = $NoGuia
GROUP BY Transporte, Material";
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                            ...
                                            for ($i = 0; $i < $lista_Guias; $i++) {
                                                ...
                                                echo "<td>";
                                                echo $lista_Guias['UnidadesTotales'];
                                                echo "</td>";
                                                ...
                                                echo "<td>";
                                                echo $lista_Guias['total_pallets'];
                                                echo "</td>";

                                                echo "<td>";
                                                echo $lista_Guias['total_piking'];
                                                echo "</td>";
