...
try{
    ...
    $sqlDatos = " select Bodega,Carril,Posicion,Nivel,Ubicacion,posiciones.IDH,Descripcion,FechaProduccion,EstatusUbicacion,Observaciones from posiciones   inner join productos on posiciones.IDH = productos.IDH where posiciones.Estado = 'Ocupada' order by  Bodega Desc, Carril Asc, CONVERT(SUBSTRING(Posicion, 2), SIGNED INTEGER) Desc , Nivel Desc,FechaProduccion ASC; ";
...
switch ($accion) {
    ...
    case 'btnIngresarMovimiento':
        ...
        $txtUOrigne = (isset($_POST['txtUOrigen'])) ? $_POST['txtUOrigen'] : "";
        $txtUDestino = (isset($_POST['txtUDestino'])) ? $_POST['txtUDestino'] : "";
        ...
        $txtUOrigne = $txtBodegaOrigen."-".$txtCarrilOrigen."-".$txtPosicionOrigen."-".$txtNivelOrigen;
        ...
        $txtNivel = (isset($_POST['txtNivelINP'])) ? $_POST['txtNivelINP'] : "";
        $txtUDestino = $txtBodega."-".$txtCarril."-".$txtPosicion."-".$txtNivel;


        $txtMontaargiosta = (isset($_POST['txtMontacarguiasta'])) ? $_POST['txtMontacarguiasta'] : "";
        ...
        $cargos = "SELECT posiciones.IDH, productos.Descripcion as Descripcion FROM dbs9098416.posiciones 
join productos  
on posiciones.IDH = productos.idh
where Ubicacion = '$txtUOrigne' and posiciones.Estado = 'Ocupada';";
        ...
        if ($result->num_rows > 0) {
            ...
            $conn = new mysqli($servername, $username, $password, $dbname);
            $cargos = "SELECT * FROM dbs9098416.posiciones where Ubicacion = '$txtUDestino' and Estado = 'Libre';";
            ...
            if ($result->num_rows > 0) {
                ...
                $txtQRY = "insert into dbs9098416.Reubicaciones values (null,'$txtIDH','$txtDescripcion','$txtUOrigne','$txtUDestino','$fechaActualizacion',null,'Pendiente','$txtUsuario','$txtMontaargiosta',null);";
               ...
               // echo $txtQRY;
                ...
                $Mensajeerror = '<div class="alert alert-secondary alert-dismissible bg-success text-white border-0 fade show" role="alert">
                                    ...
                                    <strong>Se asigno correctamente el movimiento desde '.$txtUOrigne.' hacia '.$txtUDestino.' -- </strong> al operador de montacargas '.$txtMontaargiosta.'
                                </div>';
                ...
                $Mensajeerror = '<div class="alert alert-secondary alert-dismissible bg-danger text-white border-0 fade show" role="alert">
                                    ...
                                    <strong>La Ubicacion de Destino es incorrecta  ('.$txtUDestino.'), o no esta Libre -- </strong> Por favor Ingresa una ubicacion que si este en las bodegas y asegurece que este Libre.
                                </div>';
            ...
            $Mensajeerror = '<div class="alert alert-secondary alert-dismissible bg-danger text-white border-0 fade show" role="alert">
                                    ...
                                    <strong>La Ubicacion  de Origen ('.$txtUOrigne.') es incorrecta o no esta Ocupada para poder Moverla a ('.$txtUDestino.') -- </strong> Por favor Ingresa una ubicacion valida.
                                </div>';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Re Ubicar unidades de forma individual </h4>
                            <h6 class="card-subtitle">Los productos entran a la lista de reubicaciones de un montacarguista</h6>
                            <br>
                            ...
                            <div>
                                ...
                                <div class="my-content formulario">
                                    <form role="form" action="" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <h4 class="card-title"> Ubicacion de Destino </h4>
                                            <h6 class="card-subtitle">Seleccione la Ubicacion en la que se requiere mover el Pallet</h6>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12" style="text-align: center">
                                                    <button type="submit" value="btnIngresarMovimiento" name="accion"
                                                            class="btn btn-outline-success">Registrar Movimiento
                                                    </button>
                                                </div>
                                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body ">
                                        <h4 class="card-title">Consulte en que Ubicaciones exite un IDH  </h4>
                                        <h6 class="card-subtitle">Puede buscar po descripcion o por IDH</h6>
                                        <br>
                                            ...
                                            <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                                ...
                                                for ($i = 0; $i < $lista_Productos; $i++) {
                                                    ...
                                                    echo "<td>";
                                                    echo $lista_Productos['EstatusUbicacion'];
                                                    echo "</td>";


                                                    echo "<td>";
                                                    echo $lista_Productos['Observaciones'];
                                                    echo "</td>";
...
<!-- Script para listas dinamicas  Destino-->
