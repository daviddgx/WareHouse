...
$cargos = "select distinct(Carril) as Carril from dbs9098416.posiciones  where Bodega = '".$Area."' and Estado = 'Ocupada' and EstatusUbicacion = 'Calidad' ";
...
<script type="text/javascript">
    function recargarListaPosicionesOrigen() {
        ...
        $.ajax({
            type: "POST",
            url: "TraerPosicionDesbloquear.php",
