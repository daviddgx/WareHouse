...
$cargos = "SELECT IDH, count(*) as Cantidad FROM dbs9098416.posiciones where Bodega = '".$Area."' and Carril = '".$Carril."' and Estado = 'Ocupada' and EstatusUbicacion not in ( 'Calidad','Cuarentena') group by IDH";


  echo '<label>IDH a Bloquear</label>
