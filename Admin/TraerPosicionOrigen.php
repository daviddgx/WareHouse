...
$cargos = "select distinct(Posicion) as Posicion from dbs9098416.posiciones  where  Bodega = '".$Area."' and Carril = '".$Carril."' and Estado = 'Ocupada'
";
