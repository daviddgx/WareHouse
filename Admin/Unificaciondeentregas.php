...
include '../LQS_EUQ/LST_UnificarEnvios.php';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Unificacion de Entregas</h4>
                            <h6 class="card-subtitle">Puede cambiarla configuracion de unificacion de entregas para clientes especificos  </h6>
                            <br>
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav ">
                                        <li class="nav-item active">
                                            <a class="btn btn-outline-success" style="margin-left: 2rem" href="Crear_CNFUnificarEntregas.php"><span > Configurar Cliente para unificar entregas </span></a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
                            ...
                            <form role="form" action="" method="post" class="">
                                <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                    ...
                                    for ($i = 0; $i < $lista_Productos; $i++) {
                                        ...
                                        echo "<td>";
                                        echo '<a href="BorrarUnificacionEntregas.php?Cliente=' . $lista_Productos['Cliente'] . '" class="far fa-eye-slash btn btn-Sertero "></a>';
                                        echo "</td>";
