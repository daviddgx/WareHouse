            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Mantenimiento de Usuarios Administrativos</h4>
                            <h6 class="card-subtitle">Revisar los usuarios de Administracion </h6>
                            <br>
                                ...
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav ">
                                        <li class="nav-item active">
                                            <a class="btn btn-outline-success" style="margin-left: 2rem" href="CrearUsuario.php"><span> Crear Usuario </span></a>
                                        </li>
                            ...
                            <form role="form" action="" method="post" class="">
                                <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                    ...
                                    for ($i = 0; $i < $lista_Productos; $i++) {
                                        ...
                                        echo "<td>";
                                        echo $lista_Productos['Nombre'];
                                        echo "</td>";

                                        echo "<td>";
                                        echo $lista_Productos['Apellido'];
                                        echo "</td>";

                                        echo "<td>";
                                        echo $lista_Productos['Nombre_Usuario'];
                                        echo "</td>";

                                        echo "<td>";

                                    switch ($lista_Productos['TipoUsuario']) {

                                        case '0':
                                            echo "Administrador de APP";
                                            break;

                                        case '1':
                                            echo "Administrador FIFO";
                                            break;

                                        case '2':
                                            echo "Operador de Montacargas";
                                            break;
                                        ...
                                        echo "</td>";
                                        echo "<td>";
                                        echo $lista_Productos['Fecha_Creacion'];
                                        echo "</td>";

                                        echo "<td>";
                                        echo $lista_Productos['Fecha_Actualizacion'];
                                        echo "</td>";

                                        echo "<td>";
                                        echo $lista_Productos['Email'];
                                        echo "</td>";

                                        echo "<td>";

                                        echo '<a href="EditarUsuario.php?IDUsuario=' . $lista_Productos['CodigoUsuario'] . '" class="btn btn-success ">Editar 📝</a>';
                                        echo "</td>";
                                        echo "</tr>";
