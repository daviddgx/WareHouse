            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Mantenimiento de Usuarios Administradores de Inventario</h4>
                            <h6 class="card-subtitle">Registre Nuevos usuarios para el rol de Administrador de inventarios </h6>
                            <br>
