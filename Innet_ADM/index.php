                                ...
                                <div class="col-lg-12 col-md-12 animate__animated  animate__backInRight">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h4 class="card-subtitle"> Total de Bultos Despacho: <span id="TotalBultosDespacho"></span>  --- Promedio: <span id="PromBultosDespacho"></span> Bultos</h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12 col-md-12 animate__animated animate__backInRight">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title">Top 10 proximos a vencer</h4>
                                                <canvas id="Top10AVencer" height="120"> </canvas>
...
FROM (SELECT DISTINCT bodega FROM posiciones) AS b
...
try {
    ...
    TIME(D.FechaRealizado) AS HoraDeDespacho, 'Notas', 
    IFNULL(TIMESTAMPDIFF(MONTH, date(D.FechaRealizado), date(PH.FechaVencimiento)), 'No se puede calcular') AS MesesVidaUtil, 
    'Tapando/NoTapando', PH.EstatusUbicacion AS ProductoEsta, PR.CAJASXPALET, PR.LINEA, PR.PESOBRUTOCAJA as PesoPorCaja,PH.UnidadesEnPallet as Cajas,0 as CajasPK, (PR.PESOBRUTOCAJA * PH.UnidadesEnPallet) /1000 as PesoDeDespacho,
    D.FechaRealizado AS FechaDespacho, MONTHNAME(FechaRealizado) AS MES, DATE_FORMAT(FechaRealizado, '%W') AS nombre_dia,
    CONCAT(
        TIMESTAMPDIFF(DAY, D.FechaRealizado, D.FechaRealizado), ' días, ',
        HOUR(TIMEDIFF(D.FechaRealizado, D.FechaRealizado)), ' horas, ',
...
var valorToneladas = <?php echo $TotalAsignacionesINF2; ?>;
toneladasElement.textContent = valorToneladas;
...
var valorToneladas3 = <?php echo round($TotalAsignacionesINF2 / $Registros,2); ?>;
toneladasElement3.textContent = valorToneladas3;
...
try {
    ...
    where PS.Estado = 'Ocupada' group by PS.IDH  order by Count(*) desc limit 10";
    $result = $conn->query($sql);
...
inner join productos PR on PR.IDH =Top10aVencer.IDH order by Pallets desc";
    $result = $conn->query($sql);
...
<script>
    ...
    new Chart(document.getElementById("Top10AVencer").getContext('2d'), {
        ...
        options: {
            ...
            title: {
                display: true,
                text: 'Proximos 10 IDHs a vencer'
            },
            scales: {
                yAxes: [{
                    ticks: {
