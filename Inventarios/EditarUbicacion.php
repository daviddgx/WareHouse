...
try {
    if (isset($TxtID)) {
        ...
        $sql = "SELECT IDH,Producto,FechaRegistro,Estado, Operador,Verificador,Cantidades,Origen, FechaVencimiento, FechaCuarentena, Posicion FROM dbs9098416.asignaciones where Numero = '" . $TxtID . "'";
        ...
        $txtFechaRegistro =  date('d/m/Y', strtotime($Producto['FechaRegistro']));
...
switch ($accion) {
    case "btnActualizar":
        ...
        $txtCantidades = (isset($_POST['txtCantidades'])) ? $_POST['txtCantidades'] : "";
        ...
        if(validarCadena($posicion)) {
            ...
            CorregirUbicacion($posicion,$TxtID,$txtCantidades);
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item active">
                        <a class="btn btn-outline-danger" style="margin-left: 2rem" href="Print_Cardex.php"><span > Regresar </span></a>
                    </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="txtCantidades"
                                                           class="form-control"
                                                           value="<?php echo $txtCantidades ?>"  required>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- FIN Row para Elemento de formulario -->
