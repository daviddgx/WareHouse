...
switch ($accion) {
    ...
    case "btnConsultar":
        ...
        include '../LQS_EUQ/RPT_Ingresos_Produccion.php';
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h4 class="card-title">Bitacora de Movimientos</h4>
                                <h6 class="card-subtitle"> Valide los tiempos de los movimientos</h6>
                                <br>

                                <div class="text-right">
                                    <a href="../FPDF2/ReporteIngresos.php?FInicio=<?php echo $txtFechaInicial2?>&FFinal=<?php echo $txtFechaFinal2?>" target= "_blank" class="btn btn-success"> <i class="fas fa-file-pdf"></i> Generar Reporte</a>
                                </div>
                                <br>
