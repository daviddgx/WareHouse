...
switch ($accion) {
    ...
    case "btnIngresosMasivos" :

        $txtBodega = (isset($_POST['ListaBodegas'])) ? $_POST['ListaBodegas'] : "";
        $txtCarril = (isset($_POST['txtCarrilINP'])) ? $_POST['txtCarrilINP'] : "";

        $Ubicacion = $txtBodega."-".$txtCarril."-";
        $posicion = $Ubicacion;



            // 0. Vallidar las Ubicaciones
        if(validarCadena($posicion)) {
            $Mensajeerror = '<div class="alert alert-danger" role="alert"><br><p><strong> Ingrese la Ubicaion Inicial de forma correcta. No se guardaron los datos </div>';

        } else if(validarCadena($posicion2)) {
            $Mensajeerror = '<div class="alert alert-danger" role="alert"><br><p><strong> Ingrese la Ubicaion Final de forma correcta. No se guardaron los datos </div>';

        } else {
            // 1. Determinar la cantidad de Ubicaciones
            ...
            if ($conn->connect_error) {
                ...
                $sql = "SELECT count(*) As Registros FROM dbs9098416.posicioneswhere Ubicacion like '$Ubicacion%'  and Estado = 'Libre';";
                echo $sql;
                ...
                try {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo  "Cantidad de registros:" . $row['Registros'];
                        ...
                        $Mensajeerror =
                            '<div class="alert alert-danger" role="alert"><br><p><strong> El rango de ubicaciones no es correcto, por favor valide que sea el inicio y el final de un carril  </div>';
                    }
            ...
            // 2. Insertar en la tabla temporal los datos de las Asignaciones.
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">1. Datos para Imprimir Ingresos, Esta trabajando en el <?php echo $HoraTrabajo;?></h4>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="txtFechaRec" type="text" class="form-control" value="<?php echo $fecha; ?>" required readonly>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label># Lote</label>
                                                        <input name="txtLoteProd" type="text" class="form-control" value="G.M <?php echo $fecha; ?>">
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">2. Seleccione el inicio de las ubicaciones del Producto</h4>
                            <h6 class="card-subtitle">Seleccione la ubicacion Inicial del producto</h6>
                            ...
                            <div class="my-content formulario">
                                ...
                                <div class="form-body">
                                    ...
                                    <br>
                                    <h4 class="card-title">3. Seleccione el Final de las ubicaciones del Producto</h4>
                                    <h6 class="card-subtitle">Seleccione la ubicacion Final del producto (Solo se admiten rangos de carriles)</h6>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label>Bodega</label>

                                                <select  class="funy form-control ng-pristine ng-valid ng-valid-required ng-touched" name="ListaBodegas2" id="ListaBodegas2" ng-model="properties.value" ng-options="ctrl.getValue(option) as (ctrl.getLabel(option) | uiTranslate) for option in properties.availableValues" ng-required="properties.required" ng-disabled="properties.disabled">
                                                    <option style="display:none; height:50px;" value="" class="ng-binding">
                                                        --- Bodega ---
                                                    </option>
                                                    <?php
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="hidden" name="txtCarrilINP2" value="" id="txtCarrilINP2">
                                                <!-- Ingresando Selects Dinamicos -->
                                                <div id="Select_Area2">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="hidden" name="txtPosicionINP2" value="" id="txtPosicionINP2">
                                                <div id="Select_Posicion2">
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <input type="hidden" name="txtNivelINP2" value="" id="txtNivelINP2">
                                                <div id="Select_Niveles2">
                                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 centrado">
                                            <div class="form-group text-center" >
                                                <button type="submit" value="btnIngresosMasivos" name="accion" class="btn btn-outline-success">Registrar Ingresos
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                    ...
                                    for ($i = 0; $i < $lista_DespachoPRODUCCION; $i++) {
                                        ...
                                        switch ($lista_DespachoPRODUCCION['Estado']){
                                            case 'Pendiente' :
                                                echo "<td>";
                                                echo '<a href="Cardex.php?Ubicacion='.$lista_DespachoPRODUCCION['Posicion'].'" target="_blank" class="btn btn-outline-dark "> <i class="fas fa-print"></i> Imprimir</a>';
                                                echo "</td>";
                                        ...
                                        echo "<td>";
                                        echo '<a href="LayOut.php?Ubicacion='.$lista_DespachoPRODUCCION['Posicion'].'" class="btn btn-outline-warning "><i class="fas fa-warehouse"></i> LayOut</a>';
                                        echo "</td>";
                                        echo "</tr>";
...
<!-- Script para listas dinamicas Final-->

<script type="text/javascript">
    $(document).ready(function(){

        recargarLista2();
        $('#ListaBodegas2').change(function(){
            recargarLista2();
...
<script>
    function cambiarValorCarril2() {
        var select = document.getElementById("ListaCarril2");
        var input = document.getElementById("txtCarrilINP2");
        input.value = select.value;
    }
</script>

<script>
    function cambiarValorPosicion2() {
        var select = document.getElementById("ListaPosicion2");
        var input = document.getElementById("txtPosicionINP2");
        input.value = select.value;
    }
</script>

<script>
    function cambiarValorNivel2() {
        var select = document.getElementById("ListaNivel2");
        var input = document.getElementById("txtNivelINP2");
        input.value = select.value;
    }
</script>
<!-- Cargar Area-->
