...
switch ($accion) {
    ...
    case 'btnIngresarMovimiento':
        ...
        $Mensajeerror = '<div class="alert alert-secondary alert-dismissible bg-info text-white border-0 fade show" role="alert">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                        <span aria-hidden="true">×</span>
                                    </button>
                                    <strong>Esta Funcionalidad aun no esta Disponible -- </strong> Estamos validando las reglas del negocio para que cumpla correctamente con la funcionalidad esperada ⚙️🔨⛏️
                                </div>';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Liberar el producto colocado en una ubicacion. </h4>
                            ...
                            <div>
                                ...
                                <h4 class="card-title"> El formato es: BODEGA-CARRIL-POSICION-NIVEL </h4>
                                <h6 class="card-subtitle">Todo en mayusculas, Ej: B1-A1-P1-N1 para la bodega 1, Carril A1 Posicion P1 y Nivel 1</h6>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label>Ubicacion a Liberar</label>
                                                        <input type="text" id="miInput" name="txtUOrigen" value="<?php echo $txtUOrigne?>">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ¿Está seguro de que desea liberar la ubicación?
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
                                                            <button type="submit" value="btnIngresarMovimiento" name="accion" class="btn btn-primary">Sí, liberar ubicación</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
