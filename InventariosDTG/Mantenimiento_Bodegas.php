...
<script>
    $(document).ready(function() {
        $('#example').DataTable( {
            ...
            pageLength: 25 // Establece el número de registros por página a 25
            ,
            select: {
                style: 'single'
            }
            ...
            columnDefs: [
                {
                    targets: 0, // La columna que quieres tratar como números
                    type: 'num' // Especifica que es de tipo numérico
                }
            ]
        });
    });
