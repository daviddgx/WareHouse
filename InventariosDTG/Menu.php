...
<nav class="sidebar-nav">
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item"><a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><i class="fas fa-prescription-bottle"></i><span class="hide-menu">Ingreso de <br> Detergentes </span></a>
            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                <li class="sidebar-item"><a href="Print_Cardex.php" class="sidebar-link"><span class="hide-menu"> Ingresos
                                        </span></a>
                                        </li>

                                        <li class="sidebar-item"><a href="Print_CardexMasivo.php" class="sidebar-link"><span class="hide-menu"> Ingresos Masivos <br>/ Importaciones
                                        </span></a>
                                        </li>

                                        <li class="sidebar-item"><a href="Print_CardexMasivoCargadosIDH.php" class="sidebar-link"><span class="hide-menu"> Impriir Etiquetas 
                                        </span></a>
                                        </li>
        ...
        <li class="sidebar-item"><a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false"><i class=" fas fa-chart-pie"></i><span class="hide-menu">Consultas </span></a>
            ...
            <li class="sidebar-item"><a href="Consultar_Ingresos.php" class="sidebar-link"><span class="hide-menu"> Ingresos
                ...
                <li class="sidebar-item"><a href="Tiempos_Ingresos.php" class="sidebar-link"><span class="hide-menu"> Tiempos
                                        </span></a>

                </li> <li class="sidebar-item"><a href="Posiciones_Bitacora.php" class="sidebar-link"><span class="hide-menu"> Bitacora
                                        </span></a>
                </li>
    ...
    <li class="sidebar-item"><a class="sidebar-link has-arrow" href="javascript:void(0)"
        ...
        <ul aria-expanded="false" class="collapse  first-level base-level-line">
            ...
            <li class="sidebar-item"><a href="LiberarBodega.php" class="sidebar-link"><span
                        class="hide-menu"> Liberar Bodega
                                        </span></a>
            </li>
            -->
        </ul>
