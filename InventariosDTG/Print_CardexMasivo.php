...
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                                ...
                                $fechaProduccion = $fecha_formateada . " " . $hora;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">1. Datos para Imprimir Ingresos, Esta trabajando en el <?php echo $HoraTrabajo; ?>  Ingreso de Detergentes</h4>
