...
include '../LQS_EUQ/LST_DespachosProduccionPLFirmeIDH.php';
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Lista de Importacion</h4>
                            <h6 class="card-subtitle"> Valide los registros ingresado en el Turno para imprimir las etiquetas</h6>
                            <br>
                            <!-- Start First Cards -->
                            <!-- *************************************************************** -->
                            ...
                            <div class="dataTables_wrapper" style="overflow-x: auto;">
                                <table id="example" class="table table-striped  " cellspacing="0" width="100%">
                                    ...
                                    for ($i = 0; $i < $lista_DespachoPRODUCCION; $i++) {
                                        ...
                                        // Detale de Productos
                                                echo "<td>";
                                                echo '<a href="Print_CardexMasivoCargados.php?IDH='.$lista_DespachoPRODUCCION['IDH'].'" class="btn btn-outline-info "><i class="fas fa-table"></i> Listar Productos</a>';
                                                echo "</td>";
