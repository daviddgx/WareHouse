...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
       ...
       // $FechaETQ= date('Y-m-d', strtotime( $row['FechaRegistro'] ));
...
<div class="red-box">
    <div class="element-box">
        <div class="box-content">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="TextoBlanco" >FECHA DE PRODUCCION</label>
    ...
    <div class="element-box">
        <div class="box-content">
            ...
            <?php 
                $fechaHoraActual = date('d-m-Y H:i:s'); // Obtener la fecha y hora actual en el formato deseado
                echo " <span style='font-size: 10px;'>Fecha de impresión: $fechaHoraActual</span>";
                ?>
             </div>
    </div>
</div>
