...
switch ($accion) {
    ...
    case "btnConsultar":
        ...
        include '../LQS_EUQ/RPT_Ingresos_ProduccionPL.php';
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-right">
                                <a href="../FPDF2/ReporteIngresosPL.php?FInicio=<?php echo $txtFechaInicial2?>&FFinal=<?php echo $txtFechaFinal2?>" target= "_blank" class="btn btn-success"> <i class="fas fa-file-pdf"></i> Generar Reporte</a>
                            </div>
                            <br>
