            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">Liberar Unidades de un Carril Completo </h4>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="txtDestino"  name="txtCarril" value="<?php echo $txtCarril?>" placeholder="En Mayusculas ej: P1">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ¿Está seguro de que desea liberar Todo el Carril?
                                                        </div>
