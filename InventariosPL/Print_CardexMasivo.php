...
switch ($accion) {
    ...
    case "btnBorrarCarga":
        ...
        $sql = "DELETE FROM `asignacionesPL` where EstatusProducto = 'PL'";
        $conn->query($sql);
    ...
    case "btnIngresosMasivos":
        ...
        $posicion = $Ubicacion;
        $fecha_formateada = (isset($_POST['txtFechaRec'])) ? $_POST['txtFechaRec'] : "";
        ...
        // 0. Vallidar las Ubicaciones
            ...
            if ($conn->connect_error) {
                ...
                $sql = "SELECT count(*) As Registros FROM dbs9098416.posiciones where Ubicacion like '$Ubicacion%'  and Estado = 'Libre';";
                ...
                try {
                    ...
                    //$fecha_formateada = date_format($fechaForm, 'Y-m-d');
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            $sql2 = "SELECT Ubicacion FROM dbs9098416.posiciones where Ubicacion like '$Ubicacion%'  and Estado = 'Libre';";

                            $resultUB = $conn->query($sql2);
                            $row2 = $resultUB->fetch_assoc();
                            for ($i = 0; $i < $Registros; $i++) {


                                $sql3 = "INSERT INTO `asignacionesPL` (`Numero`, `IDH`, `Producto`, `Posicion`, `FechaRegistro`, `FechaColocado`, `Estado`, `Operador`, `PalletCompleto`, `Cantidades`, `Origen`, `FechaProduccion`, `LoteProduccion`, `FechaIngreso`, `FechaVencimiento`, `FechaCuarentena`, `Verificador`, `EstatusProducto`, `Observaciones`)
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
                                ...
                                $posicion = $row2['Ubicacion'];
                                $row2 = $resultUB->fetch_assoc();
                                
                                (isset($_POST['txtMontacarguista'])) ? $_POST['txtMontacarguista'] : "";
                                ...
                                $hora2 = (isset($_POST['txtHora'])) ? $_POST['txtHora'] : "";
                                $fechaProduccion = $fecha_formateada . " " . $hora2;
                                $loteProduccion = (isset($_POST['txtLoteProd'])) ? $_POST['txtLoteProd'] : "";
                                $fechaIngreso = $fechaConsulta . " " . $hora2;
                                ...
                                $fechaVencimiento = date('Y-m-d', strtotime($fecha_formateada . ' + ' . $txtDiasVencimiento . ' days'));
                                $fechaCuarentena = date('Y-m-d', strtotime($fecha_formateada . ' + ' . $txtDiasCuarentena . ' days'));
    ...
    case "btnPonerEnFirme":
        PonerEnFirmeLasUbicaciones();
        break;
...
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        $origen = (isset($_POST['txtOrigen'])) ? $_POST['txtOrigen'] : "";
        $hora2 = (isset($_POST['txtHora'])) ? $_POST['txtHora'] : "";
        $fechaProduccion = $fechaConsulta . " " . $hora2;
...
<div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <h4 class="card-title">1. Datos para Imprimir Ingresos, Esta trabajando en el <?php echo $HoraTrabajo; ?>  Ingreso de PL</h4>
                                    ...
                                    <form role="form" action="" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-group">
                                                        <label>Hora (ej: 12:30:00)</label>
                                                        <input name="txtHora" type="time" class="form-control" value="<?php echo $hora; ?>" required>
                                                    </div> -
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="form-group">
    ...
    <div class="form-group">
        <label># Lote</label>
        <input name="txtLoteProd" id="txtLoteProd" type="text" class="form-control" value="G.M <?php echo date('d-m-Y'); ?>">
    </div>
</div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">2. Seleccione el carril de las ubicaciones a colocar</h4>
                            <h6 class="card-subtitle">puede eliminar la ubicaciones que no requiera despues, en el resumen</h6>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 centrado">
                                            <div class="form-group text-center" >
                                                <button type="submit" value="btnIngresosMasivos" name="accion" class="btn btn-outline-info">Calcular Ubicaciones
                                                </button>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Calculo de Ubicaciones.</h4>
                            <h4 class="card-title"> Debe confirmar en el boton de abajo para que llegue el trabajo al montacarguista.</h4>
                            <h6 class="card-subtitle"> Elimine,Edite o agregue mas ubicaciones.</h6>
                            <br>
                            ...
                            <div class="dataTables_wrapper" style="overflow-x: auto;">
                                    ...
                                    for ($i = 0; $i < $lista_DespachoPRODUCCION; $i++) {
                                        ...
                                        switch ($lista_DespachoPRODUCCION['Estado']) {
                                            case 'Pendiente':
                                                ...
                                                echo "<td>";
                                                echo '<a href="EditarUbicacionPL.php?Ubicacion=' . $lista_DespachoPRODUCCION['Numero'] . '" class="btn btn-outline-info "><i class="fas fa-pen-square"></i> Cambiar</a>';
                                                echo "</td>";
                                ...
                                <div class="row">
                                    <div class="col-md-12 centrado">
                                        <div class="form-group text-center" >
                                            <button type="submit" value="btnPonerEnFirme" name="accion" class="btn btn-outline-success">Estoy Seguro, Ingresar estas unidades!!
                                            </button>
                                    ...
                                    <div class="col-md-12 centrado">
                                        <div class="form-group text-center" >
                                            <button type="submit" value="btnBorrarCarga" name="accion" class="btn btn-outline-danger">Borrar todas las ubicaciones calculadas
                                            </button>
