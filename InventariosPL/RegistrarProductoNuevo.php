...
switch ($accion) {
    ...
    case "btnBuscar":
        ...
        $txtIDH = (isset($_POST['txtIDH'])) ? $_POST['txtIDH'] : "";
            ...
            $sql = "SELECT IDH,Descripcion,Base,Altura,Foto FROM dbs9098416.productos where IDH = $txtIDH;";
            ...
            try {
                ...
                if ($result->num_rows > 0) {
                    ...
                    $Mensajeerror =
                        '<div class="alert alert-secondary" role="alert"><br><p><strong> El Producto IDH: '.$txtIDH.' no existe, Notifique al responsable para registrarlo  </div>';
                }
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body background-color: red;">
                            <h4 class="card-title">Creacion de Producto no registrado</h4>
                            <h6 class="card-subtitle">Registra producto Nuevo</h6>
                            <br>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="txtCodigoDeBarras" type="text"
                                                           class="form-control"
                                                           value="<?php echo $txtCodigoDeBarras ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="txtPesoNetoUnitario" type="number" id="PnetoUnitario"
                                                           class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="txtPesoBrutoUnitario" type="number" id="PBrutoUnitario"
                                                           class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="txtPesoNetoCaja" type="number" id="PesoNetoUnitarioCaja"
                                                           class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="txtPesoBrutoCaja" type="number" id="PBrutoUnitarioCaja"
                                                           class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="txtEstado" type="text"
                                                           class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"
                                                           value="<?php echo $txtEstado?>"  required>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- FIN Row para Elemento de formulario -->
