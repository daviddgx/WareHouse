...
on  b.Nombre_Usuario = asignaciones.Operador where  EstatusProducto is null and FechaRegistro  BETWEEN '".$HoraTrabajoInicio."' and '".$HoraTrabajoFinal."'  order by FechaIngreso desc; ";
