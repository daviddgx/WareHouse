...
if(strtotime($hora) < strtotime($Turno2) && strtotime($hora) > strtotime($Turno1)  ){
    ...
    $sqlDatos = "SELECT asignacionesPL.*,concat(b.nombre,' ',b.Apellido) as nombreOperador  FROM dbs9098416.asignacionesPL join usuarios_app b
on  b.Nombre_Usuario = asignacionesPL.Operador where asignacionesPL.Verificador = '$UsuarioOP' order by FechaIngreso desc;";
