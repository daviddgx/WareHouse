...
on  b.Nombre_Usuario = asignaciones.Operador where  FechaRegistro  BETWEEN '".$HoraTrabajoInicio."' and '".$HoraTrabajoFinal."' and EstatusProducto = 'PL' order by FechaIngreso desc;";
