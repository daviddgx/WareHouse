...
if(strtotime($hora) < strtotime($Turno2) && strtotime($hora) > strtotime($Turno1)  ){
    ...
    $Verificador = $_SESSION['Usuario'];
    $sqlDatos = "SELECT IDH,Producto FROM dbs9098416.asignaciones where EstatusProducto = 'PL' and Estado = 'Pendiente' and Verificador = '$Verificador' Group by IDH,Producto";
