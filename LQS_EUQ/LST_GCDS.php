...
try {
    ...
    $sqlDatos = "select Transporte,FechaPedido,FechaEngrega,NombreDestino,lugar,Transportista,pais,Estatus,Piloto from dbs9098416.Guias where Estatus !='Despachado' group by Transporte,FechaPedido,FechaEngrega,NombreDestino,lugar,Transportista,pais,Estatus,Piloto";
