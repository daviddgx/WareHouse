...
try{
    ...
    $sqlDatos = "SELECT *  FROM dbs9098416.asignaciones where Operador = '".$NombreUsuario."' and FechaColocado between date('$FechaInicioConsulta') and date('$FechaFinConsulta')";
